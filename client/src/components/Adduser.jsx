...
const AddUser = ({ setShowAdd }) => {
  ...
  const getUsers = async () => {
    try {
      const { data } = await axios.get(
        `http://localhost:8040/api/v1/users/${1}`
      );
  ...
  //     "http://localhost:8040/api/v1/users",
  //     user
  //   );
  //   })
  ...
  return (
    <div className="absolute h-screen w-full flex justify-center items-center z-10 bg-white bg-opacity-60">
      <div className="bg-white rounded-lg shadow-xl transform -translate-y-8">
        ...
        >
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="bg-blue-500 text-white py-2 px-8 rounded-lg hover:bg-blue-600 focus:outline-none focus:bg-blue-600"
            >
              Add User
            </button>
          </div>
